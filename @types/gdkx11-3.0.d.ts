 ...
 */
function x11_get_xatom_by_name_for_display(display: X11Display, atom_name: string | null): xlib.Atom
/**
 ...
 */
function x11_get_xatom_name_for_display(display: X11Display, xatom: xlib.Atom): string | null
/**
...
module X11Cursor {
    ...
    interface ConstructorProperties extends Gdk.Cursor.ConstructorProperties {
    }
...
module X11DeviceManagerCore {
    ...
    interface ConstructorProperties extends Gdk.DeviceManager.ConstructorProperties {
    }
...
module X11DeviceManagerXI2 {
    ...
    interface ConstructorProperties extends X11DeviceManagerCore.ConstructorProperties {
...
interface X11Display {
     ...
     */
    string_to_compound_text(str: string | null): [ /* returnType */ number, /* encoding */ Gdk.Atom, /* format */ number, /* ctext */ Uint8Array ]
    /**
     ...
     */
    text_property_to_text_list(encoding: Gdk.Atom, format: number, text: number, length: number, list: string | null): number
    /**
     ...
     */
    utf8_to_compound_text(str: string | null): [ /* returnType */ boolean, /* encoding */ Gdk.Atom, /* format */ number, /* ctext */ Uint8Array ]
...
module X11DisplayManager {
    ...
    interface ConstructorProperties extends Gdk.DisplayManager.ConstructorProperties {
    }
...
module X11DragContext {
    ...
    interface ConstructorProperties extends Gdk.DragContext.ConstructorProperties {
    }
...
module X11Keymap {
    ...
    interface ConstructorProperties extends Gdk.Keymap.ConstructorProperties {
    }
...
module X11Screen {
    ...
    interface ConstructorProperties extends Gdk.Screen.ConstructorProperties {
    }
...
module X11Visual {
    ...
    interface ConstructorProperties extends Gdk.Visual.ConstructorProperties {
    }
...
module X11Window {
    ...
    interface ConstructorProperties extends Gdk.Window.ConstructorProperties {
    }
